...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_media_external_id"), "media", ["external_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "AIRING", "FINISHED", "UPCOMING", "CANCELLED", name="mediastatusenum"
            ),
            nullable=True,
        ),
    ...
    op.create_index(
        op.f("ix_media_tags_media_id"), "media_tags", ["media_id"], unique=False
    )
    op.create_index(
        op.f("ix_media_tags_media_type"), "media_tags", ["media_type"], unique=False
    )
    op.create_index(
        op.f("ix_media_tags_tag_id"), "media_tags", ["tag_id"], unique=False
    )
    op.create_table(
        "movies",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tracking_media_id"), "tracking", ["media_id"], unique=False
    )
    op.create_index(
        op.f("ix_tracking_media_type"), "tracking", ["media_type"], unique=False
    )
